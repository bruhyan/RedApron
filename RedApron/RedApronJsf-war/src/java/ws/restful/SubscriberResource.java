...
public class SubscriberResource {
    ...
    /**
     * Retrieves representation of an instance of ws.restful.SubscriberResource
     * @return an instance of java.lang.String
     */
    @Path("retrieveSubscriber/{id}")
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Response retrieveSubscriber(@PathParam("id") Long id) {
        try
        {
    ...
    public Response retrieveAllSubscribers(){
        try{
            ...
            System.out.println("subscriberList: " + subscriberEntities);
            RetrieveAllSubscribersRsp retrieveAllSubscribersRsp = new RetrieveAllSubscribersRsp(subscriberEntities);
            System.out.println("subscriberRsp: " + retrieveAllSubscribersRsp.getSubscriberEntities());
